...
namespace Chatter.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "chatId,UserId,ChatMessage,TimeStamp")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "chatId,UserId,ChatMessage,TimeStamp")] Chat chat)
        {
            if (ModelState.IsValid)
            {
